...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/SURAJSALAINI12/SAINI",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/quizbysu")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/unique_boy11")
